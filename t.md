...
![](./media/media/image2.png){width="5.46875in"
...
![](./media/media/image27.png){width="6.510416666666667in"
...
![](./media/media/image13.png){width="5.989583333333333in"
...
![](./media/media/image29.png){width="7.5in"
...
![](./media/media/image14.png){width="7.5in" height="2.25in"}
...
7.  On the far left is a file browser (note the little 'refresh' icon at
    > the top: ![](./media/media/image8.png){width="0.375in"
...
![](./media/media/image21.png){width="7.5in"
...
11. Rename your session from 'Untitled Session' to something more
    ...
    > ![](./media/media/image42.png){width="0.23958333333333334in"
...
![](./media/media/image32.png){width="5.53125in" height="0.53125in"}

22. Or it's in the the Session drop down (when there's little room for
    > buttons):

![](./media/media/image12.png){width="3.71875in"
...
![](./media/media/image26.png){width="3.4166666666666665in"
height="1.4375in"}
...
![](./media/media/image11.png){width="2.4270833333333335in"
...
![](./media/media/image19.png){width="6.276042213473316in"
height="5.340670384951881in"}

7.  On the left is a little chain link button:
    > ![](./media/media/image44.png){width="0.3940004374453193in"
...
![](./media/media/image39.png){width="6.816174540682415in"
height="7.630208880139983in"}

9.  Scroll to the top of the window and you'll see this on the far
    > right:

![](./media/media/image20.png){width="1.328125546806649in"
...
![](./media/media/image34.png){width="3.151042213473316in"
height="1.3670669291338582in"}

14. And then 'Generate Share Link' (your URL will be similar, but
    > different from this one):

![](./media/media/image22.png){width="3.3281255468066493in"
...
![](./media/media/image17.png){width="4.807292213473316in"
...
3.  In the Create new Project window that comes up provide a name for
    ...
    > template:\
    > ![](./media/media/image16.png){width="4.682292213473316in"
...
![](./media/media/image49.png){width="7.5in"
height="4.083333333333333in"}
...
![](./media/media/image30.png){width="7.5in"
...
![](./media/media/image25.png){width="6.052083333333333in"
...
![](./media/media/image41.png){width="7.5in"
...
![](./media/media/image15.png){width="7.5in"
...
![](./media/media/image36.png){width="7.5in" height="4.25in"}
...
> ![](./media/media/image38.png){width="3.71875in" height="9.46875in"}
...
![](./media/media/image18.png){width="7.5in"
...
2.  ![](./media/media/image47.png){width="6.5in"
...
4.  ![](./media/media/image23.png){width="6.5in"
    > height="4.069444444444445in"}
...
![](./media/media/image31.png){width="6.458333333333333in"
height="0.8125in"}
...
![](./media/media/image45.png){width="6.5in" height="2.25in"}
